          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                className="h-[52px] w-full rounded-[14px] border border-[#DCD9D0] bg-[#FFFDF9] px-4 text-[14px] outline-none placeholder:text-[#AAA8A0] focus:border-[#6654D9] focus:ring-2 focus:ring-[#6654D9]/10"
              />
            </div>
